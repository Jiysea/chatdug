...
<div :class="{ 'block': open, 'hidden': !open }"
    class="fixed inset-y-0 right-0 w-64 z-30 bg-white border-l border-gray-200 transform transition-transform duration-300 ease-in-out hidden sm:hidden">
    <div class="h-full flex flex-col">
        <button @click="open = ! open"
            class="fixed top-3 right-2 p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
